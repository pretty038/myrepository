    ...
    <body>
							...
							<div class="container">
								...
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									<ul class="nav navbar-nav navbar-right">
										...
										<li class="active"><a href="single">Single</a></li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="single-detail">
							<h1>授之于鱼不如授之于渔</h1>
							<img class="img-responsive" src="../images/video-img2.jpg" alt="" /> 
							
							<blockquote><p style="font-size: 15px; color: #999; letter-spacing: 0.5px;word-spacing: 1px;">Web design graecis iracundia nec. Assueverit consequuntur mei, eos cu mutat percipitur.No quandoiudicabit usu, est in melius dolorum scriptorem. Summo gubergren te mei, eam torquatos abhorreant ne.Pri meis illud nobis ut legere tempor eripuit te sed. Verterem phaedrum consectetuer et quo. Omniumdisputation graecis iracundia nec. Assueverit consequuntur mei, eos cu mutat percipitur.No quandoiudicabit usu, est in melius dolorum scriptorem. Summo gubergren.</p>
							</blockquote>	
					...
					<div class="col-md-12">
						<div class="single-detail">
							<h1>不抛弃，不放弃</h1>
							<img class="img-responsive" src="../images/video-img3.jpg" alt="" /> 
							<p>学习是场马拉松</p>
							<blockquote><p style="font-size: 15px; color: #999; letter-spacing: 0.5px;word-spacing: 1px;">Web design graecis iracundia nec. Assueverit consequuntur mei, eos cu mutat percipitur.No quandoiudicabit usu, est in melius dolorum scriptorem. Summo gubergren te mei, eam torquatos abhorreant ne.Pri meis illud nobis ut legere tempor eripuit te sed. Verterem phaedrum consectetuer et quo. Omniumdisputation graecis iracundia nec. Assueverit consequuntur mei, eos cu mutat percipitur.No quandoiudicabit usu, est in melius dolorum scriptorem. Summo gubergren.</p>
							</blockquote>	
		...
		<section class="bottom-footer">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						Copyrights 2015 All Reseved More Templates <a href="http://www.cssmoban.com/" target="_blank" title="Ä£°åÖ®¼Ò">Ä£°åÖ®¼Ò</a> - Collect from <a href="http://www.cssmoban.com/" title="ÍøÒ³Ä£°å" target="_blank">ÍøÒ³Ä£°å</a></div>
