...
<body>
	...
	<form id="tab" action="./insert" method="post">
			<div class="col" id="dv2">
				<div class="childW">
					<div id="cinQues">
						<p class="neip">问题:<input name="tQuestions.question" type="text" /></p>
						<p class="neip">答案:<input name="tAnswers.answer" type="text"/></p>
						<p class="neip">选项:<input name="tChoises[0].choise" type="text" /></p>
					</div>				
	...
	<div class="btDiv1"><button class="bt1" onclick="AddCin()">添加新的选项框</button>
	<button class="bt1" onclick = "deleteDiv()">delete option</button></div>	
