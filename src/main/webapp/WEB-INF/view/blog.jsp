						...
						<nav class="navbar navbar-default">
							<div class="container">
								...
								<div class="navbar-header">
									...
									<a class="navbar-brand" href="index"><i class="fa fa-skyatlas"></i> Sky<span>Blue</span></a>
								</div>
			...
			<div class="page-header">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1>我们的故事</h1>
							<p>时光荏苒，岁月穿梭，变化的是我们的容颜，不变的是我们的经历</p>
						</div>
					</div>	
				</div>	
			</div>	
