    ...
    <body>
						...
						<nav class="navbar navbar-default">
							<div class="container">
								...
								<div class="navbar-header">
									...
									<a class="navbar-brand" href="index"><i class="fa fa-skyatlas"></i> 先<span>知</span></a>
								</div>
								...
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									<ul class="nav navbar-nav navbar-right">
										...
										<li class=" dropdown">
											<a href="portfolio-1" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Portfolio <i class="fa fa-caret-down"></i></a>
		...
		<section class="Contact">
			<div class="page-header">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1>联系我们 （Contact With Us）</h1>
							<p>地址  ：北京市朝阳区惠新东街紫光发展大厦A座4层057室</p>
							<p>电话：15313917102 <br> 64823822 - 9000</p>
							<p>Office Location:A-4-057,#11 Huixindong Street, Chaoyang District, Beijing</p>
							<p>Phone：15313917102 <br> 64823822 - 9000</p>
						</div>
					</div>	
				</div>	
			</div>	
						...
						<div class="contact-form">
							...
							<form>
								<div class="form-group">
									...
									<input type="email" class="form-control input-lg" id="exampleInputEmail1" placeholder="Your Name">
								</div>
								
								<div class="form-group">
									<label class="sr-only" for="exampleInputEmail1">Your Email</label>
									<input type="email" class="form-control input-lg" id="exampleInputEmail1" placeholder="Your Email">
								</div>
								
								<div class="form-group">
									<label class="sr-only" for="exampleInputEmail1">Your Message</label>
									<textarea class="form-control input-lg" rows="4" placeholder="Your Message"></textarea>
								</div>
		...
		<section class="bottom-footer">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						Copyrights 2015 All Reseved More Templates <a href="http://www.cssmoban.com/" target="_blank" title="我们的主页">我们的主页</a> - Collect from <a href="http://www.cssmoban.com/" title="ryan" target="_blank">ryan</a></div>
